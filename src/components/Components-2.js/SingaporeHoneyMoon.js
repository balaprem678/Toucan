...
import singapore_1 from "../../img/Singapore HoneyMoon/singapore-1.avif";
import singapore_2 from "../../img/Singapore HoneyMoon/singapore-2.avif";
import singapore_3 from "../../img/Singapore HoneyMoon/singapore-3.avif";

import Navigation from "../Navigation";
import Footer from "../Footer";

function SingaporeHoneyMoon() {
  return (
    <div className="SingaporeHoneyMoon">
      <Navigation />
      <div className="thailand-home">
        <h4 className="head-2">SingaporeHoneyMoon Vacation Packages</h4>
        <h1 className="head-1">
      ...
      <div className="tour-packages">
        <div className="container ">
          <div className="tour-package-card margins">
            <div className="row">
              <div className="col-lg-4 col-md-3 col-sm-12">
                <img src={singapore_1} alt="" />
              </div>
              <div className="col-lg-8 col-md-6 col-sm-12 content-section">
                <h5>Energizing 11 Days Tour Package to Singapore for Couple</h5>
                <ul>
                  <li>James Bond One Day Trip By Long Tail Boat</li>
                  <li>
                    Phi Phi island tour by Speedboat to marvel at colourful
      ...
      <div className="tour-packages">
        <div className="container ">
          <div className="tour-package-card margins">
            <div className="row">
              <div className="col-lg-4 col-md-3 col-sm-12">
                <img src={singapore_2} alt="" />
              </div>
              <div className="col-lg-8 col-md-6 col-sm-12 content-section">
                <h5>
                  Skintillating 4 Days Couple Travel Packages to Singapore
                </h5>
                <ul>
                  <li>James Bond One Day Trip By Long Tail Boat</li>
                  <li>
      ...
      <div className="tour-packages">
        <div className="container ">
          <div className="tour-package-card margins">
            <div className="row">
              <div className="col-lg-4 col-md-3 col-sm-12">
                <img src={singapore_3} alt="" />
              </div>
              <div className="col-lg-8 col-md-6 col-sm-12 content-section">
                <h5>
                Extravagant 5 Days Couple Travel Packages to Singapore
                </h5>
                <ul>
                  <li>James Bond One Day Trip By Long Tail Boat</li>
                  <li>
